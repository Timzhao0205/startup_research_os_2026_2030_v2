<task>
Build source corpus batch: Biomedical, medtech, bio-instrumentation, regulation.
</task>
...
<batch_target>
Batch ID: BATCH_06_BIOMEDICAL_MEDTECH
Topic: Biomedical, medtech, bio-instrumentation, regulation
Minimum qualifying sources for this batch: 35
</batch_target>

<focus>

Focus on FDA, NIH, PubMed/NCBI, ClinicalTrials.gov, NMPA, WHO, EMA, IMDRF, Nature Biomedical Engineering, Science Translational Medicine, IEEE biomedical engineering sources, medical-device standards.

Topics: medical devices, bioinstrumentation, sensors, surgical/clinical hardware, point-of-care systems, lab automation, hospital workflow bottlenecks, AI-enabled devices with hardware/regulatory wedge, China NMPA pathway, US FDA pathway.
