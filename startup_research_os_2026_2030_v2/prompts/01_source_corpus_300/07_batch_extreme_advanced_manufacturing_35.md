<task>
Build source corpus batch: Extreme environments, aerospace-adjacent, nuclear/fusion/geothermal/hydrogen, advanced materials.
</task>
...
Focus on DOE/national labs, NASA if relevant, IAEA, ITER, PPPL, INL, ORNL, IEEE, Nature/Science, standards bodies, advanced materials journals, aerospace-adjacent public sources, geothermal/hydrogen/nuclear official sources.

Topics: extreme temperature, radiation, pressure, corrosion, high magnetic fields, high power density, high reliability, downhole systems, nuclear/fusion components, hydrogen infrastructure, advanced materials, harsh-environment robotics and electronics.
