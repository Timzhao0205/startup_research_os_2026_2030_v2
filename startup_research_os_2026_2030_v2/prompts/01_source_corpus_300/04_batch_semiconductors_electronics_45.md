<task>
Build source corpus batch: Semiconductors, electronics, packaging, advanced manufacturing.
</task>
...
<batch_target>
Batch ID: BATCH_04_SEMICONDUCTORS_ELECTRONICS
Topic: Semiconductors, electronics, packaging, advanced manufacturing
Minimum qualifying sources for this batch: 45
</batch_target>

<focus>

Focus on IEEE, IEDM/APEC/ECCE, NIST, CHIPS, BIS, SEMI, SIA, WSTS, imec, CEA-Leti, Fraunhofer, TechInsights, Yole, Semiconductor Engineering, compound semiconductor technical sources, JEDEC, IPC.

Topics: advanced packaging, chiplets, power electronics, WBG, EDA-adjacent tooling, test/inspection only as limited subset, specialty components, reliability, thermal, supply chain, packaging, equipment gaps, China localization, US export controls.
...
2. Qualifying source table with at least 45 sources.
