<task>
Build source corpus batch: US policy, funding, export controls, standards, regulation.
</task>
...
<batch_target>
Batch ID: BATCH_02_US_POLICY_EXPORT
Topic: US policy, funding, export controls, standards, regulation
Minimum qualifying sources for this batch: 40
</batch_target>

<focus>

Focus on official US sources: whitehouse.gov, commerce.gov, bis.gov, nist.gov, chips.gov, energy.gov, arpa-e.energy.gov, fda.gov, nih.gov, nsf.gov, darpa.mil, federalregister.gov, regulations.gov, congress.gov, crsreports.congress.gov, uscc.gov, treasury.gov, ofac.treasury.gov, sec.gov.

Topics: CHIPS, export controls, AI/data center policy, energy funding, grid regulation, advanced manufacturing, medtech/FDA, biosecurity, SBIR/STTR, procurement, national labs, standards, China-facing restrictions.
