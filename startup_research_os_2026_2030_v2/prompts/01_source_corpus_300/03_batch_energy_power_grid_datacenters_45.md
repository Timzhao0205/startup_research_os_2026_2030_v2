<task>
Build source corpus batch: Energy, power, grid, data centers, climate infrastructure.
</task>
...
<batch_target>
Batch ID: BATCH_03_ENERGY_POWER_GRID_DATACENTERS
Topic: Energy, power, grid, data centers, climate infrastructure
Minimum qualifying sources for this batch: 45
</batch_target>

<focus>

Focus on IEA, DOE, ARPA-E, EIA, FERC, NERC, national labs, IEEE, standards bodies, IRENA, grid operators, and peer-reviewed literature.

Topics: power electronics, high-voltage systems, grid modernization, DER/VPP, interconnection, data center energy, thermal management, long-duration storage, batteries, hydrogen, geothermal, industrial electrification, extreme energy systems.
